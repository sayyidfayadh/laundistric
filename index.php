            ...
            <section>
                <section class="container py-5">
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-7">
                      <div class=" ">
                        <span class="badge   bg-primary px-3 py-2 mb-3 fw-semibold">Free Express Delivery</span>
                      </div>
                        ...
                        <a href="tel:+1234567890" class="btn btn-primary d-inline-flex align-items-center gap-2">
                          Call | WhatsApp
            ...
            <section class="container py-5">
                <div class="row g-4 align-items-stretch">
                  ...
                  <div class="col-lg-5 d-flex position-relative">
                    <div class="bg-white rounded-4  w-100 d-flex align-items-center justify-content-center">
                        <a href="tel:+123456789" class="position-arrangement btn btn-outline-light fw-semibold px-4 py-2 rounded-2 d-inline-flex align-items-center gap-2">
                            Call | WhatsApp
              ...
              <div class="container">
                <div class="row align-items-stretch align-item-center align-content-center py-5">
                    ...
                    <div class="col-lg-5 col-12 d-flex">
                      <div class="row">
                       <div class="col">
                        <img src="assets/img/m 1.png" alt="App Promo" class="img-fluid w-100" style="object-fit: contain; border-radius: 1rem;">
                       </div>
                       <div class="col">
                        <img src="assets/img/qq 1.png" alt="App Promo" class="img-fluid w-100" style="object-fit: contain; border-radius: 1rem;">
                       </div>
                      </div>
                    </div>
          ...
          <div class="card border-0 shadow-sm rounded-4 overflow-hidden w-100 d-flex flex-column">
            ...
            <div class="card-body d-flex flex-column flex-grow-1">
              ...
              <div class="mt-auto align-content-end">
                <a href="Blogs.html" class="button-fancy-gradient-3">
                  Read More
                </a>
              </div>
            </div>
                        ...
                        <div class="col-lg-2 col-md-6">
                            <div class="footer-widget">
                                ...
                                <ul class="address-list">
                                    ...
                                    <li><a href="">Laundristic Services</a></li>
